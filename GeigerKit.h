...
PROGMEM const char * const menu_table[] = 	// PROGMEM array to hold MENU strings
{   
  string_0,
  string_1,
  string_2,
...
const char unit_lcd_2[] PROGMEM = "mR/h";
#endif
PROGMEM const char * const unit_lcd_table[] = { // PROGMEM array to hold unit strings
  unit_lcd_0,
  unit_lcd_1,
  unit_lcd_2
};
...
PROGMEM const char * const unit_table[] = { // PROGMEM array to hold unit strings
  unit_0,
  unit_1,
  unit_2
};
